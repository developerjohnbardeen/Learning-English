...
public class UnitSqliteOpenHelper extends SQLiteOpenHelper {
    ...
    private static final String UNIT_ID = "_id"; //use it is UNIT_NUMBER as well
    private static final String UNIT_IMG = "UNIT_IMG";
    private static final String UNIT_TITLE = "UNIT";
    private static final String UNIT_AUDIO = "UNIT_AUDIO";
    private static final String UNIT_COMPLETE_WORD_AUDIO = "COMPLETE_WORD_AUDIO";
    private static final String UNIT_STORY = "UNIT_STORY";
    ...
    public UnitSqliteOpenHelper(Context context) {
