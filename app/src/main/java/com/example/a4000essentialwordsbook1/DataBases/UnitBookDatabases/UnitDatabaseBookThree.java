...
public class UnitDatabaseBookThree extends SQLiteOpenHelper {
    private static final String UNIT_DATABASE = TablesNote.UNIT_DATABASE_BOOK_3;
    ...
    public UnitDatabaseBookThree(Context context) {
