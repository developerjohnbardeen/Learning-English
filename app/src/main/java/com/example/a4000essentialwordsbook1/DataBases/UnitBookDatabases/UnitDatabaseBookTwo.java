...
public class UnitDatabaseBookTwo extends SQLiteOpenHelper {
    private static final String UNIT_DATABASE = TablesNote.UNIT_DATABASE_BOOK_2;
    ...
    public UnitDatabaseBookTwo(Context context) {
