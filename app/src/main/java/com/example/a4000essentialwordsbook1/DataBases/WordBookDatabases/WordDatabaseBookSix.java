...
public class WordDatabaseBookSix extends SQLiteOpenHelper {

    private static final int DB_VERSION = 1;
    private static final String BOOK_ONE_WORD_DATABASE = TablesNote.WORD_DATABASE_BOOK_6;
    public Context dbContext;
    private final InsertTablesValues insert = new InsertTablesValues();


    public WordDatabaseBookSix(Context context){
