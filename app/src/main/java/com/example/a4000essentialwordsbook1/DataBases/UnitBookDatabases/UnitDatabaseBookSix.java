...
public class UnitDatabaseBookSix extends SQLiteOpenHelper {
    private static final String UNIT_DATABASE = TablesNote.UNIT_DATABASE_BOOK_6;
    ...
    public UnitDatabaseBookSix(Context context) {
