...
public class UnitDatabaseBookFive extends SQLiteOpenHelper {
    private static final String UNIT_DATABASE = TablesNote.UNIT_DATABASE_BOOK_5;
    ...
    public UnitDatabaseBookFive(Context context) {
