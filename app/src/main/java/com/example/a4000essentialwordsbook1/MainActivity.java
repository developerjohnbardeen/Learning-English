...
import com.example.a4000essentialwordsbook1.StringNote.DB_NOTES.SharedPreferencesNotes;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, NavigationView.OnNavigationItemSelectedListener{
    ...
    private final String resumeStudyCardView = SharedPreferencesNotes.resumeStudyCardViewVisibilityPreferences;
    ...
    private void findViewsById(){
        ...
        cardView = findViewById(R.id.main_nav_card_view);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case (R.id.main_search_text_view):
                ...
                break;
            case (R.id.main_image_view_icon):
                cardviewVisibility();
                break;
            default:
                break;
    ...
    private void cardviewVisibility(){
        if (isVisible()){
            cardView.setVisibility(View.VISIBLE);
        }else {
            resumeStudyPreference();
            if (isVisible()){
                cardView.setVisibility(View.VISIBLE);
            }
        }
    ...
    private void resumeStudyPreference(){

        SharedPreferences sharedPreferences = getSharedPreferences(resumeStudyCardView, MODE_PRIVATE);
    ...
    private boolean isVisible(){
        SharedPreferences sharedFlag = getSharedPreferences(resumeStudyCardView, Context.MODE_PRIVATE);
